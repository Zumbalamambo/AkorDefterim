...
import com.cnbcyln.app.akordefterim.Adaptorler.AdpSarkiListesiDragDropExpLST;
import com.cnbcyln.app.akordefterim.R;

public class SarkiListesiDragDropExpandableListView extends ExpandableListView {
    ...
    private AdpSarkiListesiDragDropExpLST adapter;
    private DragDropListeners listeners;
    private int dragOffset = 50;
    private boolean dragOnLongPress;
    private boolean pressedItem;
    private Handler handler = new Handler();

    public SarkiListesiDragDropExpandableListView(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    private void drag(int x, int y) {
        if (mDragView != null) {
            ...
            } else layoutParams.y = y - mDragPointOffset;
    ...
    public void setAdapter(ExpandableListAdapter adapter) {
        ...
        this.adapter = (AdpSarkiListesiDragDropExpLST) adapter;
    }
    ...
    private void hideItem(View itemView, int[] position) {
        ...
        ImageView iv = itemView.findViewById(R.id.move_icon_customizer_item);
        if (iv != null)
     ...
     */
    public DragDropListeners getListeners() {
        return listeners;
    }
     ...
     */
    public void setListeners(DragDropListeners listeners) {
