...
package com.cnbcyln.app.akordefterim.fastscroll_listview;
...
class IndexScroller {
	...
	IndexScroller(Context context, ListView lv) {
		YaziFontu = new AkorDefterimSys(context).FontGetir(context, "anivers_regular");
	...
	void draw(Canvas canvas) {
		...
		if (mSections != null && mSections.length > 0) {
			...
			if (mCurrentSection >= 0) {
				...
				previewTextPaint.setTypeface(YaziFontu);
			...
			indexPaint.setTypeface(YaziFontu);
