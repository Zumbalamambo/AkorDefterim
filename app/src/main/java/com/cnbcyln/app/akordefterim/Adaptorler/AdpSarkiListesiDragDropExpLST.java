...
public final class AdpSarkiListesiDragDropExpLST extends BaseExpandableListAdapter{
	...
	public AdpSarkiListesiDragDropExpLST(Context context, Map<String, ArrayList<String>> child) {
		init(context, new int[] { android.R.layout.simple_list_item_1 },
				new int[] { android.R.id.text1 },child);
	}

	public AdpSarkiListesiDragDropExpLST(Context context, int[] itemLayouts, int[] itemIDs,
	...
	public View getChildView(int groupPosition, int childPosition,
		...
		if (groupPosition != selectedGroup && childPosition != selectedChild) {
			...
			ImageView iv = convertView.findViewById(R.id.move_icon_customizer_item);
